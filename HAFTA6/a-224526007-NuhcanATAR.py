# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 12:51:45 2023
...
btn_1 = ttk.Button(anaform, text="Temizle", command=inputTemizle)
btn_hesapla = ttk.Button(anaform, text="Hesapla", command=kurHesapla,)


lbl_tlmiktar.grid(row=0, column=0,padx=25)
e_miktar_giris.grid(row=0,column=1,pady=5,padx=25)
lbl_kurturu.grid(row=1,column=0,pady=5,padx=25)
cmb_kursec.grid(row=1,column=1,pady=5,padx=35)
